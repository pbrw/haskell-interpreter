...
transProgram x = case x of
  Program _ decls topdefs -> failure x
...
transInstr :: Show a => Instr a -> Result
transInstr x = case x of
  DInstr _ decl -> failure x
  SInstr _ stmt -> failure x
transDecl :: Show a => Decl a -> Result
transDecl x = case x of
  CostBlk _ ident block -> failure x
  Var _ type_ items -> failure x
transBlock :: Show a => Block a -> Result
transBlock x = case x of
  Block _ instrs -> failure x
transLoopBlk :: Show a => LoopBlk a -> Result
transLoopBlk x = case x of
  LoopBlk _ instrs -> failure x
