...
instance Print (Program a) where
  prt i e = case e of
    Program _ decls topdefs -> prPrec i 0 (concatD [prt 0 decls, prt 0 topdefs])
...
instance Print (Arg a) where
  prt i e = case e of
    ...
    RefArg _ type_ id -> prPrec i 0 (concatD [doc (showString "ref"), prt 0 type_, prt 0 id])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
instance Print (Instr a) where
  prt i e = case e of
    DInstr _ decl -> prPrec i 0 (concatD [prt 0 decl])
    SInstr _ stmt -> prPrec i 0 (concatD [prt 0 stmt])
  prtList _ [] = (concatD [])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
instance Print (Decl a) where
  prt i e = case e of
    CostBlk _ id block -> prPrec i 0 (concatD [doc (showString "cost"), prt 0 id, prt 0 block])
    Var _ type_ items -> prPrec i 0 (concatD [prt 0 type_, prt 0 items, doc (showString ";")])
  prtList _ [] = (concatD [])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
instance Print (Block a) where
  prt i e = case e of
    Block _ instrs -> prPrec i 0 (concatD [doc (showString "{"), prt 0 instrs, doc (showString "}")])

instance Print (LoopBlk a) where
  prt i e = case e of
    LoopBlk _ instrs -> prPrec i 0 (concatD [doc (showString "{"), prt 0 instrs, doc (showString "}")])
...
instance Print (Stmt a) where
  prt i e = case e of
    ...
    MultiBrk _ expr -> prPrec i 0 (concatD [doc (showString "break"), prt 0 expr, doc (showString ";")])
    Print _ expr -> prPrec i 0 (concatD [doc (showString "print"), prt 0 expr, doc (showString ";")])
  prtList _ [] = (concatD [])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
